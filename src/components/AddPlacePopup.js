...
function AddPlacePopup(props) {
  ...
  return (
    <PopupWithForm
      title="Новое место" name="popup_add" isOpen={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit} buttonName="Создать">
      <>
        ...
        <div className="popup__form-input">
          <input id="link-place" name="link-place" className="popup__input popup__input_link_place" value={url} onChange={handleEdirUrl} type="url" placeholder="Ссылка на картинку" required/>
